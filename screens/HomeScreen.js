    ...
    <View style={styles.container}>
      <View style={styles.navWrapper}>
        <StyledHomeButton
          ...
          goToScreen={() => goToScreen("DonateList")}
        />
        <StyledHomeButton
          text={"Donations"}
          image={require("./../assets/icons/donations.png")}
          goToScreen={() => goToScreen("DonationRequests")}
        />
      ...
      <View style={styles.navWrapper}>
        <StyledHomeButton
          ...
          image={require("./../assets/icons/volunteer.png")}
          goToScreen={() => goToScreen("VolunteerList")}
        />
      </View>
      <View style={styles.navWrapper}>
        <StyledHomeButton
          text={"Organizations"}
          goToScreen={() => goToScreen("Organizations")}
          image={require("./../assets/icons/donate.png")}
        />
        <StyledHomeButton
          text={"Requests"}
          image={require("./../assets/icons/request.png")}
          goToScreen={() => goToScreen("Requests")}
        />
      </View>
    </View>
  );
