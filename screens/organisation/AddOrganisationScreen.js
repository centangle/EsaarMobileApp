    ...
    return (
      <ScrollView style={Style.pageContainer}>
        ...
        <View style={styles.formInput}>
          <Text style={[Style.mb2, Style.ml1, Style.colorGray]}>
            Select Image
          </Text>
          <ImagePickerOption
            multiImage={false}
            isBase64={true}
            onChooseImage={this.selectedImages}
          />
        </View>
        <Button
          block
          onPress={() => this.addOrganisation()}
          style={Style.defaultRadius}
        >
          <Icon name={"add"} />
          <Text style={[Style.textWhite, Style.fontSizeNormal]}>
            Add Organisation
          </Text>
        </Button>
      </ScrollView>
