...
} from "../../common/redux/organization/organization.actions";
  ...
  return (
    <ScrollView style={[Style.pageContainer]}>
      <Grid style={Style.mb3}>
        <Col style={{width: 100}}>
          <View
            style={[Style.boxLayout, Style.outerShadow, styles.imageWrapper]}
          >
            <Image
        ...
        <Col style={styles.userInfo}>
          ...
          <Row style={Style.mv1}>
            <Col>
              <Button
                onPress={() => goToScreen("JoinAsVolunteer", {id: Id})}
                block
                style={[Style.outerShadow, styles.headerActBtn]}
              >
                <Text style={Style.defaultColor}>Join</Text>
              </Button>
            </Col>
            <Col>
              <Button
                onPress={() => goToScreen("Donate", {organization: orgParam})}
                block
                style={[Style.outerShadow, styles.headerActBtn]}
              >
                <Text style={Style.defaultColor}>Donate</Text>
              </Button>
            </Col>
            <Col>
              <Button
                onPress={() => goToScreen("RequestList")}
                block
                style={[Style.outerShadow, styles.headerActBtn]}
              >
                <Text style={Style.defaultColor}>Request</Text>
              </Button>
            </Col>
          </Row>
        </Col>
        ...
        <ScrollView horizontal={true} nestedScrollEnabled={true}>
          <View style={styles.grid}>
            {organisationOpts.map((option, i) => {
              ...
              return (
                <TouchableOpacity
                  onPress={() => goToScreen(route, {id: Id})}
                  key={i}
                  style={styles.profileInnerPageBtn}
                >
                  <StyleCategoryButton
          ...
          <View style={styles.grid}>
            {categories
              ? categories.map((category, i) => {
                  ...
                  return (
                    <View key={i} style={styles.profileInnerPageBtn}>
                      <StyleCategoryButton
                        btnStyle={styles.catContainer}
                        title={Name}
      ...
      {offices.length > 0 ? (
        <View style={[Style.mv3]}>
          <Text style={[Style.heading, Style.mb2]}>Offices</Text>
