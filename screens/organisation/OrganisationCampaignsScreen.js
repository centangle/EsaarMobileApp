...
const OrganisationCampaignsScreen = (props) => {
...
const mapDispatch = dispatch => ({
  fetchOrgRequestsStart: (id) => dispatch(fetchOrgRequestsStart('FETCH_ORG_CAMPAIGNS_START', id)),
  dispatch
});

export default connect(mapState, mapDispatch)(OrganisationCampaignsScreen);
